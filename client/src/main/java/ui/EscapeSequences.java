...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_CHESS_YELLOW = SET_BG_COLOR + "150;255;150m";
    public static final String SET_BG_COLOR_CHESSGREEN = SET_BG_COLOR + "72;18;79m";
